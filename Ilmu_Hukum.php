    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
          <h3>Program Studi Ilmu Hukum</h3>
          <p class="fst-bold">
            Mempelajari Persoalan Hukum Keluarga Islam Secara Menyeluluruh (Perkawinan,Perceraian, Kewarisam, Dan
            Peradilan Agama) Dalam Bingkai Perpaduan antara nilai-Nilai Qur'aani Dan Tradisi Keindonesian.
          </p>
        </div>
      </div>
